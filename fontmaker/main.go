...
import (
	...
	"github.com/TechWizardsTeam/gopdf/fontmaker/core"
	//"runtime/debug"
)
...
func echoUsage() {
	...
	buff.WriteString("\nExample:\n")
	buff.WriteString("\tfontmaker cp874 /gopath/github.com/TechWizardsTeam/gopdf/fontmaker/map  ../ttf/Loma.ttf ./tmp\n")
	buff.WriteString("\n")
