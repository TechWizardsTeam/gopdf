...
```
go get -u github.com/TechWizardsTeam/gopdf
```
...
import (
	"log"
	"github.com/TechWizardsTeam/gopdf"
)
...
Import existing PDF power by package [gofpdi](https://github.com/TechWizardsTeam/gofpdi) created by @phpdave11 (thank you :smile:)
